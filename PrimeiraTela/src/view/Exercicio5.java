	...
	public Exercicio5() {
		...
		btnCalcular.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				float PrecoFinal= c.CalculoRefeicao(Preco, Peso);
				JOptionPane.showMessageDialog(null,"O preço final é de:" + PrecoFinal);
				
			}
		});
		btnCalcular.setBounds(151, 142, 89, 23);
		...
		lblValor.setBounds(10, 68, 171, 14);
		...
		btnLimpar.setBounds(39, 142, 89, 23);
		...
		btnFechar.setBounds(262, 142, 89, 23);
