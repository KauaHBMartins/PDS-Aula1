...
public class Exercicio4 extends JFrame {
	...
	public Exercicio4() {
		...
		btnFechar.setBounds(33, 163, 89, 23);
		...
		btnLimpar.setBounds(304, 163, 89, 23);
		...
		btnCL.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				float PrecoTotal = c.CalcularLitro(PrecoLitro, PrecoFinal);
				JOptionPane.showMessageDialog(null, "O valor é de :"+ PrecoTotal);
				
			}
		});
		btnCL.setBounds(148, 163, 123, 23);
